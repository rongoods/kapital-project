    ...
    return (
        <div className="max-w-4xl mx-auto border border-white bg-[#0a0a0a] p-4 md:p-8 font-mono shadow-2xl relative overflow-hidden my-24 animate-fade-in">
            ...
            <div className="flex justify-end p-2">
                <button onClick={() => setIsOpen(false)} className="text-gray-500 hover:text-white font-mono text-xs">
                    [X] CLOSE
                </button>
            </div>

            <div className="mb-12 text-center border-b border-[#333] pb-8">
                <h2 className="text-2xl md:text-3xl font-header mb-2">{t('partnership.title')}</h2>
                <p className="text-xs text-gray-500 tracking-widest">{t('partnership.subtitle')}</p>
            </div>

            {submitted ? (
                <div className="h-[40vh] flex flex-col items-center justify-center text-center animate-fade-in">
