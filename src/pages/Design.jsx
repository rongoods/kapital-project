    ...
    return (
        <div className="container page-wrapper animate-fade-in">
            ...
            <div className="page-header">
                <h1 className="page-title">{t('studios.design.page.title')}</h1>
                <p className="page-subtitle">{t('studios.design.page.subtitle')}</p>
            </div>
            ...
            <div className="page-content-grid">
                ...
                <section className="content-block col-span-2">
                    ...
                    <Link to="/partnership" className="btn-core group">
                        <span className="group-hover:mr-2 transition-all">→</span> [{t('studios.design.page.cta')}]
                    </Link>
                </section>
                ...
                <div className="space-y-16">
                    ...
                    <section className="content-block">
                        ...
                        <div className="service-card">
                            <h3 className="service-title">{t('studios.design.page.service.title')}</h3>
            ...
            <div className="mt-24 border-t border-[#333] pt-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="border border-[#333] p-6">
                        ...
                        <strong className="block text-white mb-2 font-header text-xl">{t('studios.design.page.breakdown.1.title')}</strong>
                        <p className="font-mono text-xs text-gray-400">{t('studios.design.page.breakdown.1.desc')}</p>
                    </div>
                    <div className="border border-[#333] p-6">
                        <span className="block font-mono text-xs text-gray-500 mb-2">02</span>
                        <strong className="block text-white mb-2 font-header text-xl">{t('studios.design.page.breakdown.2.title')}</strong>
                        <p className="font-mono text-xs text-gray-400">{t('studios.design.page.breakdown.2.desc')}</p>
                    </div>
                    <div className="border border-[#333] p-6">
                        <span className="block font-mono text-xs text-gray-500 mb-2">03</span>
                        <strong className="block text-white mb-2 font-header text-xl">{t('studios.design.page.breakdown.3.title')}</strong>
                        <p className="font-mono text-xs text-gray-400">{t('studios.design.page.breakdown.3.desc')}</p>
                    </div>
                </div>
            </div>
