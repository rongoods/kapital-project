...
export default function Marketing() {
    ...
    const capabilities = [
        { title: t('studios.marketing.capabilities.1.title'), desc: t('studios.marketing.capabilities.1.desc') },
        { title: t('studios.marketing.capabilities.2.title'), desc: t('studios.marketing.capabilities.2.desc') },
        { title: t('studios.marketing.capabilities.3.title'), desc: t('studios.marketing.capabilities.3.desc') },
        { title: t('studios.marketing.capabilities.4.title'), desc: t('studios.marketing.capabilities.4.desc') }
    ];
    ...
    return (
        <div className="container page-wrapper animate-fade-in">
            ...
            <div className="page-header mb-32 md:mb-48">
                <h1 className="page-title leading-tight">{t('studios.marketing.page.title')}</h1>
                <p className="page-subtitle mt-4">{t('studios.marketing.page.subtitle')}</p>
            </div>
            ...
            <div className="mb-32 md:mb-48 pb-12 border-b border-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    <div className="border border-white p-8 hover:bg-[#111] transition-colors h-full">
                        ...
                        <h4 className="font-header text-2xl mb-4">{t('studios.marketing.page.breakdown.1.title')}</h4>
                        <p className="font-mono text-xs text-gray-400 leading-relaxed">{t('studios.marketing.page.breakdown.1.desc')}</p>
                    </div>
                    <div className="border border-white p-8 hover:bg-[#111] transition-colors h-full">
                        <span className="block font-mono text-xs text-gray-500 mb-6">02</span>
                        <h4 className="font-header text-2xl mb-4">{t('studios.marketing.page.breakdown.2.title')}</h4>
                        <p className="font-mono text-xs text-gray-400 leading-relaxed">{t('studios.marketing.page.breakdown.2.desc')}</p>
                    </div>
                    <div className="border border-white p-8 hover:bg-[#111] transition-colors h-full">
                        <span className="block font-mono text-xs text-gray-500 mb-6">03</span>
                        <h4 className="font-header text-2xl mb-4">{t('studios.marketing.page.breakdown.3.title')}</h4>
                        <p className="font-mono text-xs text-gray-400 leading-relaxed">{t('studios.marketing.page.breakdown.3.desc')}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-32 md:mb-48">
                ...
                <div className="bg-[#111] p-12 md:p-16 border border-white">
                    <h4 className="font-header text-3xl md:text-4xl mb-6 text-white">{t('studios.marketing.page.service.title')}</h4>
