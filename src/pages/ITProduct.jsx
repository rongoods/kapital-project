...
export default function ITProduct() {
    ...
    const capabilities = [
        { title: t('studios.itProduct.capabilities.1.title'), desc: t('studios.itProduct.capabilities.1.desc') },
        { title: t('studios.itProduct.capabilities.2.title'), desc: t('studios.itProduct.capabilities.2.desc') },
        { title: t('studios.itProduct.capabilities.3.title'), desc: t('studios.itProduct.capabilities.3.desc') },
        { title: t('studios.itProduct.capabilities.4.title'), desc: t('studios.itProduct.capabilities.4.desc') }
    ];
    ...
    return (
        <div className="container page-wrapper animate-fade-in">
            ...
            <div className="page-header mb-32 md:mb-48">
                <h1 className="page-title leading-tight">{t('studios.itProduct.page.title')}</h1>
                <p className="page-subtitle mt-4">{t('studios.itProduct.page.subtitle')}</p>
            </div>
                ...
                <div className="flex flex-col justify-between">
                    ...
                    <div className="border border-white p-6 inline-block self-start">
                        <span className="font-mono text-xs uppercase tracking-widest text-[#00ff41] animate-pulse">
                            ● {t('studios.itProduct.page.purpose')}
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-32 md:mb-48 pb-12 border-b border-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    <div className="border border-white p-8 hover:bg-[#111] transition-colors h-full">
                        ...
                        <h4 className="font-header text-2xl mb-4">{t('studios.itProduct.page.breakdown.1.title')}</h4>
                        <p className="font-mono text-xs text-gray-400 leading-relaxed">{t('studios.itProduct.page.breakdown.1.desc')}</p>
                    </div>
                    <div className="border border-white p-8 hover:bg-[#111] transition-colors h-full">
                        <span className="block font-mono text-xs text-gray-500 mb-6">02</span>
                        <h4 className="font-header text-2xl mb-4">{t('studios.itProduct.page.breakdown.2.title')}</h4>
                        <p className="font-mono text-xs text-gray-400 leading-relaxed">{t('studios.itProduct.page.breakdown.2.desc')}</p>
                    </div>
                    <div className="border border-white p-8 hover:bg-[#111] transition-colors h-full">
                        <span className="block font-mono text-xs text-gray-500 mb-6">03</span>
                        <h4 className="font-header text-2xl mb-4">{t('studios.itProduct.page.breakdown.3.title')}</h4>
                        <p className="font-mono text-xs text-gray-400 leading-relaxed">{t('studios.itProduct.page.breakdown.3.desc')}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="mb-32 md:mb-48">
                ...
                <div className="bg-[#111] p-12 md:p-16 border border-white">
                    <h4 className="font-header text-3xl md:text-4xl mb-6 text-white">{t('studios.itProduct.page.service.title')}</h4>
                    <p className="font-mono text-sm text-gray-400 max-w-3xl leading-relaxed">
                        {t('studios.itProduct.page.service.desc')}
                    </p>
                </div>
            </div>
